  ...
  Comprehensive payment solutions tailored to meet the unique needs of your business.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {BUSINESS_SOLUTIONS.map((solution) => (
              <div key={solution.title} className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-sm">
                ...
                <ul className="space-y-2 mb-6">
                  <li className="flex items-start space-x-2">
                    <span className="text-primary mt-1">✓</span>
                     <span className="text-gray-700 dark:text-gray-200">Feature 1</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-primary mt-1">✓</span>
                    <span className="text-gray-700 dark:text-gray-200">Feature 2</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-primary mt-1">✓</span>
                    <span className="text-gray-700 dark:text-gray-200">Feature 3</span>
                  </li>
                </ul>
...
<section className="section-padding bg-white dark:bg-gray-950">
  <div className="container-custom">
    <div className="text-center mb-12">
      <h2 className="heading-medium text-gray-900 dark:text-white mb-4">Success Stories</h2>
      <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="bg-gray-50 dark:bg-gray-800 rounded-lg overflow-hidden shadow-sm">
        ...
        <div className="p-6">
          <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">Retail Chain Expansion</h3>
      ...
      <div className="bg-gray-50 dark:bg-gray-800 rounded-lg overflow-hidden shadow-sm">
        ...
        <div className="p-6">
          <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">School Fee Collection</h3>
          <p className="text-gray-600 dark:text-gray-300 mb-4">
      ...
      <div className="bg-gray-50 dark:bg-gray-800 rounded-lg overflow-hidden shadow-sm">
        ...
        <div className="p-6">
          <h3 className="text-xl font-semibold mb-2 text-gray-900 dark:text-white">E-commerce Integration</h3>
          <p className="text-gray-600 dark:text-gray-300 mb-4">
      ...
      <section className="section-padding bg-gray-50 dark:bg-gray-900" id="contact">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="heading-medium text-gray-900 dark:text-white mb-4">Get in Touch</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">+234 800 WRASHPAY</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">business@wrashpay.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">123 Victoria Island, Lagos, Nigeria</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-sm">
                <h3 className="text-xl font-semibold mb-6 text-gray-900 dark:text-white">Contact Our Sales Team</h3>
                <form>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <input
                        type="text"
                        id="firstName"
                        className="w-full px-4 py-2 rounded-xl bg-white dark:bg-gray-900 text-gray-900 dark:text-white border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 transition duration-200"
                      />
                    </div>
                    <div>
